...
<body>
        ...
        <div class="container-fluid px-4 d-flex align-items-center justify-content-between">
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <div class="d-flex align-items-center text-white small ms-2">
              <span class="fw-bold" id="breadcrumb-main-page">Home</span>
              <span class="mx-2">&gt;</span>
              <span id="breadcrumb-page">Tender</span>
            </div>
    ...
    <header class="about-header">
        ...
        <div class="about-overlay text-center">
            <h2 class="category-title">Post Business Tenders</h2>
            <p>Find service providers or partners by posting your business tenders.</p>
        </div>
    </header>
    <div class="container-fluid min-vh-100 py-5 bg-light-purple">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 px-4 mb-4 position-relative custom-divider">
                <form>
                    <div class="mb-3">
                        <input type="text" class="form-control form-input" placeholder="Tender heading / title">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col">
                            <input type="text" class="form-control form-input" placeholder="Budget (if applicable)">
                        </div>
                        <div class="col d-flex deadline-group">
                            <input type="date" class="form-control border-end-0 rounded-start-3" />
                            <input type="text" class="form-control border-start-0 rounded-end-3 bg-white text-muted"
                                value="(Dead Line)" disabled />
                        </div>
                    ...
                    <div class="mb-3">
                        <div class="upload-box rounded-2 p-3 text-center position-relative">
                            ...
                            <div id="upload-placeholder">
                                ...
                                <div>Choose a file or drag & drop it here<br>
                                    <small class="text-secondary">JPEG, PNG,JPG and PDF formats, Up to 10MB</small>
                                </div>
                    ...
                    <div class="card mb-4 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div class="fw-bold"><img src="{{ asset('images/palid.png') }}" class="me-2"></div>
