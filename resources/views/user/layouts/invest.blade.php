            ...
            <div class="col-lg-6 px-4 mb-4 position-relative custom-divider">
                <form>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col">
                            <input type="text" class="form-control form-input" placeholder="Investment needed / Rs.">
                        </div>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control form-input" placeholder="Equity Offered (Optional)">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <select class="form-select form-input" required>
                            <option value="" disabled selected hidden>Business Stages</option>
